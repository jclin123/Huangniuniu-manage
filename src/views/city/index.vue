    ...
    <div>
        ...
        <el-form ref="searchForm" :inline="true" :model="searchMap" style="margin-top: 20px">
            ...
            <el-form-item prop="name">
                <el-input v-model="searchMap.name" placeholder="输入城市名搜索" style="width: 200px"></el-input>
            </el-form-item>

            <el-form-item prop="name">
                <el-input v-model="searchMap.name" placeholder="输入首字母搜索" style="width: 200px"></el-input>
            </el-form-item>
        ...
        border 表格边框
         ...
         <el-table
            ...
            <el-table-column prop="cardNum" label="城市名"></el-table-column>
            <el-table-column prop="name" label="城市首字母"></el-table-column>
        ...
        -->
        <el-dialog title="城市编辑" :visible.sync="dialogFormVisible" width="500px">
            <el-form 
            :rules="rules"
            ref="pojoForm"
            label-width="100px"
            ...
            style="width: 400px;"
            :model="pojo">
                <el-form-item label="城市名" prop="cardNum" >
                <el-input v-model="pojo.cardNum" ></el-input>
                </el-form-item>
                <el-form-item label="城市首字母" prop="name" >
