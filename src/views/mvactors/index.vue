    ...
    <div>
        ...
        border 表格边框
         ...
         <el-table
            ...
            <el-table-column prop="name" label="演员名字"></el-table-column>
            <el-table-column prop="cardNum" label="演员照片"></el-table-column>
        ...
        -->
        <el-dialog title="排场编辑" :visible.sync="dialogFormVisible" width="500px">
            <el-form 
            :rules="rules"
            ref="pojoForm"
            label-width="100px"
            ...
            style="width: 400px;"
            :model="pojo">
                <el-form-item label="影院名称" prop="cardNum" >
                ...
                <el-form-item label="电影名称" prop="phone" >
