  ...
  <div>
    ...
    <el-form ref="searchForm" :inline="true" :model="searchMap" style="margin-top: 20px">
      <el-form-item prop="name">
        <el-input v-model="searchMap.name" placeholder="输入电影名称搜索" style="width: 200px"></el-input>
      </el-form-item>
      <el-form-item prop="name">
        <el-input v-model="searchMap.name" placeholder="输入电影类型搜索" style="width: 200px"></el-input>
      </el-form-item>
      <el-form-item prop="name">
        <el-input v-model="searchMap.name" placeholder="输入电影评分搜索" style="width: 200px"></el-input>
      </el-form-item>
    ...
    <el-table :data="list" height="380" border style="width: 100%;text-align:center">
      ...
      <el-table-column prop="cardNum" label="电影名称"></el-table-column>
      <el-table-column prop="name" label="类型" width="90"></el-table-column>
      <el-table-column prop="birthday" label="影片产地"></el-table-column>
      <el-table-column prop="phone" label="评分"></el-table-column>
      <el-table-column prop="integral" label="下架时间"></el-table-column>
      ...
      <el-table-column label="操作" width="350">
        <template slot-scope="scope">
          <el-button size="mini" @click="cnmviedeos()">影片演员</el-button>
          <el-button type="primary" size="mini" @click="handleAdd('dlogFormVsb','pojoForm')">添加演员</el-button>
    ...
    <el-dialog title="电影" :visible.sync="dialogFormVisible" width="500px">
      <el-form
        ...
        :model="pojo"
      >
        <el-form-item label="电影名称" prop="cardNum">
          <el-input v-model="pojo.cardNum"></el-input>
        </el-form-item>
        <el-form-item label="电影类型" prop="name">
          <el-input v-model="pojo.name"></el-input>
        </el-form-item>
        <el-form-item label="影片产地" prop="name">
          <el-input v-model="pojo.name"></el-input>
        </el-form-item>
        <el-form-item label="电影简介" prop="name">
          <el-input type="textarea" v-model="pojo.address"></el-input>
        </el-form-item>
        <el-form-item label="电影海报" prop="name">
          <el-upload
            class="upload-demo"
        ...
        <el-form-item label="电影时长" prop="name">
          <el-input v-model="pojo.name"></el-input>
        </el-form-item>
        <el-form-item label="定档时间" prop="name">
          <el-input v-model="pojo.name"></el-input>
        </el-form-item>
        <el-form-item label="剧照" prop="name">
          <!-- <el-input v-model="pojo.name"></el-input> -->
          <el-upload
            class="upload-demo"
            action="https://jsonplaceholder.typicode.com/posts/"
        ...
        <el-form-item label="预告片" prop="name">
          <el-input v-model="pojo.name"></el-input>
        </el-form-item>
        ...
        <el-form-item label="下架时间" prop="birthday">
    ...
    <!-- 为某电影院添加电影弹窗 -->
    <el-dialog title="添加演员" :visible.sync="dlogFormVsb" width="500px">
      <el-form
        :rules="rules"
        ref="pojoForm"
        label-width="100px"
      ...
      >
        ...
        <el-form-item label="演员名" prop="name">
          <el-input v-model="pojo.name" :editable="false"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    // 弹出新增窗口
    handleAdd(dfs, formName) {
      console.log(dfs);
      console.log(formName);
      // this.pojo = {}
      if (dfs === "dialogFormVisible") {
